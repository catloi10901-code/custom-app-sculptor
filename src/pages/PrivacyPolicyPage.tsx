        ...
        <div className="container max-w-[800px]">
          ...
          <div className="prose prose-lg max-w-none text-muted-foreground space-y-6">
            <section>
              ...
              <p>HOLYPray ("chúng tôi") cam kết bảo vệ quyền riêng tư và dữ liệu cá nhân của bạn. Chính sách này mô tả cách chúng tôi thu thập, sử dụng, lưu trữ và bảo vệ thông tin khi bạn sử dụng nền tảng HOLYPray.</p>
            </section>

            <section>
              <h2 className="font-serif text-foreground text-xl mb-3">2. Thông tin chúng tôi thu thập</h2>
              <ul className="list-disc pl-5 space-y-2">
                <li><strong className="text-foreground">Thông tin tài khoản:</strong> Tên, email, mật khẩu (đã mã hóa), quốc gia, ảnh đại diện.</li>
                <li><strong className="text-foreground">Nội dung người dùng:</strong> Lời cầu nguyện, bình luận, bài viết, lời chứng.</li>
                <li><strong className="text-foreground">Dữ liệu sử dụng:</strong> Lượt truy cập, thời gian, thiết bị, trình duyệt, địa chỉ IP.</li>
                <li><strong className="text-foreground">Thông tin quyên góp:</strong> Số tiền, phương thức thanh toán (không lưu thông tin thẻ).</li>
              </ul>
            </section>
            ...
            <section>
              ...
              <p>Chúng tôi <strong className="text-foreground">không bán</strong> dữ liệu cá nhân cho bên thứ ba. Thông tin chỉ được chia sẻ trong các trường hợp:</p>
              <ul className="list-disc pl-5 space-y-2">
            ...
            <section>
              ...
              <p>Chúng tôi sử dụng mã hóa SSL/TLS, mã hóa mật khẩu bcrypt, và các biện pháp bảo mật cấp doanh nghiệp để bảo vệ dữ liệu của bạn. Truy cập dữ liệu được giới hạn nghiêm ngặt theo nguyên tắc "cần biết".</p>
            </section>
            ...
            <section>
              ...
              <p>Nếu có câu hỏi về chính sách bảo mật, vui lòng liên hệ: <a href="mailto:privacy@holypray.org" className="text-primary hover:underline">privacy@holypray.org</a></p>
            </section>
          </div>
