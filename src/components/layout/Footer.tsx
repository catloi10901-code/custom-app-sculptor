...
const Footer = () => {
  ...
  const socialLinks = [
    { icon: "𝕏", href: "#" },
    { icon: "f", href: "https://www.facebook.com/HolyPrayToday" },
    { icon: "in", href: "#" },
    { icon: "▶", href: " https://www.youtube.com/@HolyPrayToday" },
  ];
            ...
            <div className="flex gap-3 mt-5">
              {socialLinks.map((item, i) => (
                <a
                  ...
                  className="w-11 h-11 rounded-full bg-gold-dim border border-border flex items-center justify-center text-lg cursor-pointer transition-all duration-300 text-primary no-underline hover:bg-primary hover:text-primary-foreground"
                >
                  {item.icon}
                </a>
              ))}
