  ...
  return (
    <section className="relative overflow-hidden" style={{ background: "#0f2347" }}>
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden hidden sm:block">
        <div
          className="absolute w-[70vw] h-[60vh] -top-[10%] -left-[10%] blur-[40px]"
          style={{
        ...
        />
        <div
          className="absolute w-[60vw] h-[70vh] -bottom-[20%] -right-[5%] blur-[50px]"
          style={{
      ...
      <div className="container relative z-10 grid grid-cols-1 lg:grid-cols-[1.3fr_0.7fr] gap-4 sm:gap-8 items-center py-6 sm:py-8 md:pt-8 md:pb-8">
        ...
        <div className="relative z-10 order-2 lg:order-1 text-center lg:text-left">
          <div
            className="inline-flex items-center gap-2 bg-gold-dim border border-primary/40 text-primary px-3 sm:px-4 py-1.5 rounded-full text-[0.65rem] sm:text-[0.82rem] font-bold tracking-widest uppercase mb-4 sm:mb-6"
          ...
          <div className="flex gap-2.5 sm:gap-4 flex-wrap justify-center lg:justify-start mb-8 sm:mb-14" style={{ animation: "fadeUp 0.9s ease 0.6s both" }}>
            <button
              ...
              className="inline-flex items-center gap-2 px-4 sm:px-7 py-2.5 sm:py-3.5 rounded-lg bg-primary text-primary-foreground font-bold text-[0.82rem] sm:text-[0.95rem] tracking-wide no-underline shadow-[0_4px_20px_rgba(197,160,89,0.35)] transition-all duration-300 hover:bg-gold-light hover:-translate-y-0.5 hover:shadow-[0_8px_30px_rgba(197,160,89,0.5)]"
            >
              {t("hero.cta1")}
            </button>
            <Link
              to="/about"
              className="inline-flex items-center gap-2 px-4 sm:px-7 py-2.5 sm:py-3.5 rounded-lg bg-transparent text-primary border-[1.5px] border-primary font-bold text-[0.82rem] sm:text-[0.95rem] no-underline transition-all duration-300 hover:bg-gold-dim hover:-translate-y-0.5"
            >
              {t("hero.cta2")}
            </Link>
          </div>
        ...
        <div className="relative flex items-center justify-center order-1 lg:order-2 overflow-visible">
          <div
            className="absolute w-[180px] h-[180px] sm:w-[260px] sm:h-[260px] md:w-[440px] md:h-[440px] rounded-full opacity-40 pointer-events-none"
            style={{
